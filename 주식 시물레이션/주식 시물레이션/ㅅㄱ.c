...
int main(void) {
	...
	char a[28][20] = { {"모아 제약"},{"로아 전력"},{"중추 공학"},{"소마고교"},{"아리란화"},{"손화 제약"},{"일클루전"},{"남화 건설"},{"사살라루"},{"일락트로"},{"남화 마트"},{"일루 건설"},{"화호라사"},{"수면 협회"},{"삼상 협회"},{"타이거즈"},{"유토피아"},{"아티아리"},{"시호이아"},{"테레콘트"},{"블마넷잡"},{"언이라화"},{"드자리블"},{"화환"},{"지니리아"},{"로디아블"},{"오브 리그"},{"개인 협회"} };//주식 각각 이름
